...
;   #------------------------------------------------------------------------------------------------------------#
		 ...
		 $yourskillrank = 8 ; Enter your current skill rank. Set based on numerical value related to chart above
		 $currentskilluses = 184 ; Enter current skill use from the menu
